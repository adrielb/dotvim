...
nnoremap gac :bufdo bd<CR>:rewind<BAR>try<BAR>vsplit<BAR>next<BAR>vsplit<BAR>next<BAR>vsplit<BAR>next<BAR>catch<BAR>argument<BAR>endtry<CR>
...
augroup localvimrc
  ...
  autocmd VimEnter,BufNewFile,BufReadPre * nested call functions#ReadLocalVimrc()
...
augroup switch_tmux
  autocmd!
  autocmd BufEnter * call functions#TmuxSwitchClient()
augroup END
